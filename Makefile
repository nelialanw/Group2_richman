...
richMan: richMan_main.o richMan_display.o richMan_mapEffect.o richMan_struct.o richMan_save.o richMan_load.o
	g++ $(PEDERROR) $^ -o $@

clean:
	rm -f richMan richMan_main.o richMan_display.o richMan_mapEffect.o richMan_struct.o richMan_save.o richMan_load.o richMan_main.tgz
